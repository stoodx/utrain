...
void CRailTickesDlg::Parser(std::wstring& strResponse, std::wstring& strJSONResult)
{
	...
	while(true)
	{
		...
		_stprintf_s(strSumTrains, nSumLenTrains, 
			L"\"train\": {%s\"number\": \"%s\", \"departure\": \"%s\", \"destination\": \"%s\", \"dep.\": \"%s\", \"duration\": \"%s\", \"arrive\": \"%s\", %s\"lux\": {\"price(ГРН)\": \"%s\", \"seats\": \"%s\"}, \"compartment_firm\": {\"price\": \"%s\", \"seats\": \"%s\"}, \"compartment\": {\"price\": \"%s\", \"seats\": \"%s\"}, %s\"third_class_firm\": {\"price\": \"%s\", \"seats\": \"%s\"},  \"third_class\": {\"price\": \"%s\", \"seats\": \"%s\"}, \"seats\": {\"price\": \"%s\", \"seats\": \"%s\"} },%s", 
